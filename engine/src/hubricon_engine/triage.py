...
- Best fit: their own brand with real pricing power and 10+ SKUs, $3M–$20M/yr, on Amazon, Shopify, or both. The floor comes from the guarantee: below $3M, or on wholesale or arbitrage inventory, the Profit Record cannot cover $6,000 a month, so every invoice would void, and the application on the site does not book those brands a call. If a prospect says they are under $3M or do not sell their own brand, say so plainly, without apology, and point them to the 60-second Teardown. Otherwise offer the 20-minute call and Hagen judges fit live.
